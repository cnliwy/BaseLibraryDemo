...
public class PhoneUtils {
     ...
     * @param key  用于存储deviceId的key
     * @param filename 存储deviceId的文件绝对路径名称
     * @return
     */
    public static String getDeviceId(String key,String filename){
        if (uuid == null) {
            ...
            synchronized (PhoneUtils.class) {
                if (uuid == null) {
                    final SharedPreferences prefs = BaseUtils.getContext().getSharedPreferences("UUID", 0);
